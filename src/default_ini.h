...
"MatchScore      = 82         ; 几何匹配最低分（越高越严格，推荐 78~88）\n"
"AmbiguityMargin = 6          ; 最佳候选至少领先第二名多少分，否则拒识\n"
...
"LogMaxSizeMB    = 10         ; 当前 hua.log 达到此体积后轮转\n"
"LogRetentionDays= 2          ; 删除超过此天数的历史轮转日志\n"
"\n"
"; --- 浮层外观 ---\n"
...
"; ---------- 自动更新（GitHub Release） ----------\n"
"[Update]\n"
"Enabled   = true             ; 总开关：false = 从不联网检查更新\n"
"AutoCheck = true             ; 启动时后台静默检查；发现新版仅弹托盘气泡提示\n"
"Channel   = stable           ; stable = 只跟正式版；beta = 也接收预发布版（beta/rc）\n"
"; 手动更新：右键托盘图标 -> 检查更新。下载校验替换后 hua 会自动重启。\n"
"\n"
...
"39 = key:f5               ; ↘↗ V 形   刷新（近似竖直的 ↓↑ 仍为独立的 28）\n"
